...
This course is called "QR2" which is not very descriptive. It would have been fair to name it "Data Science." Data science is an appropriate *core* course for college students because modern society is data-driven to a great extent. Knowing even the basics of how to work with data, and how to draw valid conclusions from data (even if it's just to be able to argue with others!) is tremendously empowering.
