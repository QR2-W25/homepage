QR2 was divided into six blocks, each covered in roughly 4 classroom hours. Each block has a theme:

::: {.callout-note collapse=true}
## Block 1: Data, variation, visualization, and trends
...
::: {.callout-note collapse=true}
## Block 2: Prediction and classification
...
::: {.callout-note collapse=true}
## Block 4: Precision (& accuracy)

The distinction between "precision" and "accuracy" is a stated theme of many statistics courses. However, the vast majority of the techniques presented, e.g. confidence intervals, are only about precision. As for accuracy, the traditional course says two things:

i. "sample randomly" and "assign treatments randomly." 
ii. Be aware how bias can creep into data collection and do your best to avoid it.

Since Block 3 covers regression and adjustment for covariates, QR2 has rather more to say about accuracy. We will return in Block 5 to another question of accuracy: how to represent hypothesized causal connections in the systems we model.
...
::: {.callout-note collapse=true}
## Block 6: Hypothetical reasonsing
...
## Class Day 18 Friday 14 March {#sec-11Mar}
...
- Assignments due:
    ...
    - The consolidated data for all students is available at [this worksheet](https://qr2-w25.github.io/homepage/projects/Census/consolidated-worksheet.html).
    - Preliminary Census written report uploaded to Populi. (Pay no attention to Populi's claim that this report is 100% of your grade. Populi doesn't know about all the other things we've been doing.) Basic model summaries and graphics for your Census "research topic." This will be the basis for your class presentation due on March 21. Formatting can be extremely rough; you will merely be cutting-and-pasting statistical summaries and graphics into an online document that you can reference from your presentation.
